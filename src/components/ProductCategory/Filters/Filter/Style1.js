...
function Style1() {
  ...
  var options = values.map(function(value){
    return <option value={value}>Style{value}</option>
  })
  var lists = values.map(function(value){
    return <li className="option " data-value={value} data-display-text>Style{value}</li>
  })
  return (
    <div className="col-md-4 col-lg-3">
      ...
      <div className="dropdown-select wide " tabIndex={0}>
        <span className="current">Style1</span>
        <div className="list">
